...
ALLOWED_HOSTS        = ['localhost', 'localhost:85', '127.0.0.1', '172.22.10.34', 'ap2.peykasa.ir',              env('SERVER', default='127.0.0.1') ]
CSRF_TRUSTED_ORIGINS = ['http://localhost:85', 'http://127.0.0.1', 'https://' + env('SERVER', default='127.0.0.1'), '172.22.10.34']
